...
public class Variable {
	...
	//변수 : Memory(RAM)에 값을 저장하기 위한 *공간* 인터넷 주소랑 같은건가? 
	...
	System.out.println("3. 탱글한 통새우살 가득 슈슈슈슈 버거 세트(9210)");
	...
	System.out.println("슈슈슈슈 버거 4개 주문");
	...
	String setOne = "KH 아카데미표 슈슈버거 세트";
	int setOnePrice = 9800;
	String setTwo = "KH 아카데미표 비크맠 셑";
	...
	public void declareVariable() {
		 ...
		 *
		 *권장하는 방법은 아니지만 동일한 타입의 변수를 선언할 떄는 한 번에 선언할 수 있음
		 *int a, b, b; <--하지말라고 알려주는 것
		 *변수를 선언하고 난 뒤 처음 값을 대입하는 과정을 초기화(Initialization)라고 함
		 *초기화를 통해 대입한 값을 초기값이라고 함
		 * 자료형 변수 = "값"; 이는 변수라는 공간에 값을 넣겠다 라는 뜻
		 *
		 */
		 ...
		 * 
		 * -식별자를 만들 때 꼭!지켜야하는 규칙!(안지키면 안 만들어짐)
		 * 
		 * 1. keyword(예약어)는 식별자로 사용할 수 없음
		 * 2. 공백은 포함할 수 없음(띄어쓰기 안됨)
		 * 3. 대소문자 구분이 있음 age, Age, aGe, agE 다 다르게 인식
		 * 4. 길이제한이 없음
		 * 5. 문자, 숫자 사용가능 특수문자는 _, $ 만 사용가능
		 * 6. 숫자로 시작하면 안됨
		 * 7.
		 * 
		 * -개발자들끼리의 암묵적인 약속(안 지키면 책상 박살남), 여기서 말하는 것은 일반적인 것들이고 회사나 집단에서는 그들만의 방법이 따로 조냊
		 * => 영어만 사용가능!
		 * 한국어로 된 자료를 미국으로 보낸다고 했을 때 변조가 일어나서 파일이 박살나 있으면 살릴 수 있나
		 * 
		 * 1. 클래스 / 인터페이스 명명 규칙
		 * 
		 * - 첫 글자는 대문자로 표기
		...
		/*
		 *  변수의 자료형
		 * Java의 기본 자료형. 원시자료형(Primitive Type) 
		 *  
		 ...
		 * 
		 * 정수형에는 4가지 자료형이 존재함
		 * byte, short, int, long 형이 존재함
		 * int 형 쓰세요~~ 
		 * long 형 사용할 때는 대입할 숫자 뒤에 "L"을 붙임
		 * 
		 * 실수형
		 * 
		 *  실수형에는 2가지 자료형이 존재함
		...
		//3. (단일) 문자형
		char money = '돈'; // 2Byte
		//단일문자에는 반드시 홑따옴표를 붙여야함
		
		//여기까지 기본자료형 / 원시 자료형 8개!!
		...
		//System.out.println("논리 자료형 : " + isTrue + ",정수 자료형 : " + intNumber + ",정수..");
